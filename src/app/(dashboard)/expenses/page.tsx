            ...
            {expenses.map((e) => (
              <TableRow key={e._id}>
                ...
                <TableCell className="text-right">
                  <Button variant="ghost" size="icon" onClick={() => handleDelete(e._id)} className="h-8 w-8 text-rose-500 hover:text-rose-700">
          ...
          <div className="space-y-3">
            ...
            {form.items.map((item, index) => (
              <div key={index} className="flex gap-2 items-end">
                ...
                <Button type="button" variant="ghost" size="icon" onClick={() => removeItem(index)} className="h-10 w-10 text-rose-500" disabled={form.items.length <= 1}>
