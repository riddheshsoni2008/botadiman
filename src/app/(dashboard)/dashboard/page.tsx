...
export default function DashboardPage() {
  ...
  useEffect(() => {
    (async () => {
      setLoading(true);
      const res = await getDashboardMetrics(period);
    ...
    ? [
        {
          ...
          sub: `${metrics.periodOrdersCount} orders`,
          icon: DollarSign,
        ...
        {
          label: "Net Profit",
          value: formatCurrency(metrics.periodRevenue - metrics.periodExpenses),
          sub: `${((((metrics.periodRevenue - metrics.periodExpenses) / (metrics.periodRevenue || 1)) * 100) || 0).toFixed(0)}% margin`,
          icon: DollarSign,
          color: metrics.periodRevenue - metrics.periodExpenses >= 0
            ? "text-indigo-600 dark:text-indigo-400"
            : "text-rose-600 dark:text-rose-400",
          bg: metrics.periodRevenue - metrics.periodExpenses >= 0
